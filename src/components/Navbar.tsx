...
function Navbar() {
  ...
  return (
    <>
      <div className=" flex h-[64px] px-[20px] justify-between items-center lg:hidden bg-base-100 w-screen sticky top-0 z-20 ">
  ...
  sticky top-0 z-20 pl-[100px] min-[2000px]:pl-[550px] ${
